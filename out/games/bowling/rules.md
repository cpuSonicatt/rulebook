...
The objective is to get the highest bowling score across 10 frames by "knocking down pins", or removing cards from play with cards, with the "ball", or cards from your hand.
...
If one of your ball cards has the same value as one of the pin cards, you can use it to make a collateral shot on to one other pin either directly to the side, or behind.
